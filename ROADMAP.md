...
| 2 🔶 | **Video Studio sözleşme geçişi:** `shared/` 2.1 modelleri, enum'lu Luna şeması, uzun shot pencereleri kodda tamam; Windows'ta yeniden analizle doğrulama bekleniyor | Planner'a güvenilir veri |
